...
const Dashboard = ()=>{
	...
	<div className={styles["profile-card-header"]}>
		<div >
    <img className={styles["profile-image"]}src={userData[0]["photoUrl"]}/>
    </div>

		<div className={styles["profile-info"]}>
			<h1 className={styles["profile-name"]}>{userData[0]["firstName"] +" "+userData[0]["lastName"]}</h1>
			<p className={styles["profile-desc"]}>Crypto Identification</p>
		</div>
	</div>
  <div className={styles["profile-card-body"]}>
                  <p className={styles["profile-desc"]}>{userData[0]["city"] + ", " + userData[0]["province"]}</p>
                  <br />
                  <div className="infoField">
                    <strong> Gender: </strong> Male
                  </div>
                  <div className="infoField">
                    <strong> DOB: </strong> {userData[0]["dob"]}
                  </div>
                  <div className="infoField">
